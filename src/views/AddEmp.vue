    ...
    async uploadImages() {
        try {
            for (let i = 0; i < this.uploadedImages.length; i++) {
                ...
                await axios.post('http://127.0.0.1:8000/upload_image/', formData);
            }
        ...
        <div class="flex h-[85%]">
            ...
            <div class="w-[40%] justify-center items-center flex">
                <div class="flex flex-col">
                    <div v-if="opC" class="relative w-[250px] h-[300px] rounded-[14px] border-[#000] border-[1px] mb-[50px]">
                        <div class="flex items-center justify-center absolute w-[50px] h-[50px] hover:w-[55px] hover:h-[55px] bg-[#F5F8FF] shadow-md cursor-pointer rounded-[5px] right-[-60px] top-1/2 transform -translate-y-1/2">
                    ...
                    <!-- upload_button -->
                    <div class="flex items-center justify-center p-[10px] rounded-[14px] bg-[#1C1C1C] mt-[10px] hover:p-[12px] cursor-pointer" @click="uploadImages">
